$(document).ready(function () {
   ...
   $.ajax({url: '/sentiment_chart', success: function (data) {
      var sentiment_data = $.parseJSON(data);
      //console.log(sentiment_data.result);
      var labels = sentiment_data.result.map(function(e) {
        return e.label;
      });
      var data = sentiment_data.result.map(function(e) {
        return e.weight;
      });;
